package eventi.capstone.Exceptions;

import eventi.capstone.Payloads.ErrorsResponseDTO;
...
public class ExceptionsHandler {
    @ExceptionHandler(eventi.capstone.Exceptions.BadRequestException.class)
